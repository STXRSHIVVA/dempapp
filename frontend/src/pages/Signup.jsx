...
const Signup = () => {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    setError('');
     console.log('Submitting signup form:', form); // Add this line
    try {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white flex items-center justify-center px-4">
      ...
      >
        <h2 className="text-3xl font-extrabold tracking-tight text-green-400 text-center mb-6">Create an Account</h2>
        ...
        <a href="/login" className="text-sm text-gray-400 hover:text-gray-300 transition block text-center">
